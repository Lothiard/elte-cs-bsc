...
sumFruits :: [FruitBatch]
sumFruits [] = 0
sumFruits (x:xs) = numberOfFruits x + sumFruits xs
  where
...
type NumberOfPear' = Integer

-- sumDifferentFruits :: [FruitBatch] -> (NumberOfApples',NumberOfGrapes',NumberOfPears')
sumDifferentFruits :: [FruitBatch] -> (NumberOfApples', NumberOfGrapes', NumberOfPear')
sumDifferentFruits batches = helper batches (0,0,0) 
  where
