...
execute_process(
  COMMAND "/usr/bin/git" show-ref "2025.08.27"
  WORKING_DIRECTORY "/home/lothiard/Elte/elte-cs-bsc/3/GPU programming/gpu_course_opencl/_deps/vcpkg-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lothiard/Elte/elte-cs-bsc/3/GPU programming/gpu_course_opencl/_deps/vcpkg-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lothiard/Elte/elte-cs-bsc/3/GPU programming/gpu_course_opencl/_deps/vcpkg-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
