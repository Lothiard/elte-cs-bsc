...
namespace ELTE.VectorDrawing.View
{
    ...
    public partial class DrawingForm : Form
    {
        ...
        {
            Graphics graphics = e.Graphics; // rajzeszköz az eseményargumentumból
        ...
        {
            Graphics graphics = _panel.CreateGraphics(); // rajzeszköz a panelből

            if (e.Button != MouseButtons.None) // ha van valamilyen egérgomb lenyomva
            {
                _panel.Refresh(); // kirajzoljuk az alakzatokat
