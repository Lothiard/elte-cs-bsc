...
namespace ELTE.TicTacToeGame.Test
{
    ...
    {
        private Mock<ITicTacToeDataAccess> _mock = null!; // az adatelérés mock-ja
        private ITicTacToeModel _model = null!;

        [TestInitialize]
        public void Initialize() // teszt inicializálása
        {
            _mock = new Mock<ITicTacToeDataAccess>();
            ...
            _model = new BasicTicTacToeModel(_mock.Object); // példányosítjuk a modellt a mock objektummal
        }
