...
namespace ELTE.TicTacToeGame.Persistence
{
    ...
    /// </summary>
    public class TicTacToeBinaryFileDataAccess : ITicTacToeDataAccess
    {
        /// <summary>
        /// Fájl betöltése.
        /// </summary>
        ...
        public async Task<Player[]> LoadAsync(String path)
        {
            ...
            {
                throw new TicTacToeDataException("Error occurred during reading.");
            }
        }
        ...
        public async Task SaveAsync(String path, Player[] values)
        {
            ...
            {
                throw new TicTacToeDataException("Error occurred during writing.");
            }
        }
    }
}
